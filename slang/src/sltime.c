...
static void sleep_cmd (int *secs)
{
   if (*secs > 0)
     sleep (*secs);
}
...
static int push_tm_struct (struct tm *tm)
{
   char *field_names [9];
   ...
   field_names [0] = "tm_sec"; int_values [0] = tm->tm_sec;
   field_names [1] = "tm_min"; int_values [1] = tm->tm_min;
   field_names [2] = "tm_hour"; int_values [2] = tm->tm_hour;
   field_names [3] = "tm_mday"; int_values [3] = tm->tm_mday;
   field_names [4] = "tm_mon"; int_values [4] = tm->tm_mon;
   field_names [5] = "tm_year"; int_values [5] = tm->tm_year;
   field_names [6] = "tm_wday"; int_values [6] = tm->tm_wday;
   field_names [7] = "tm_yday"; int_values [7] = tm->tm_yday;
   field_names [8] = "tm_isdst"; int_values [8] = tm->tm_isdst;
...
static SLang_Intrin_Fun_Type Time_Funs_Table [] =
{
   ...
   MAKE_INTRINSIC_I("sleep", sleep_cmd, SLANG_VOID_TYPE),
