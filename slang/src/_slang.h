...
#define _SLANG_BC_ICONST	SLANG_ICONSTANT
#define _SLANG_BC_DCONST	SLANG_DCONSTANT
#define _SLANG_BC_PVARIABLE	SLANG_PVARIABLE
#define _SLANG_BC_PFUNCTION	SLANG_PFUNCTION
