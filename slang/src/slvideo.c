/* -*- mode: C; mode: fold -*- */
/* Copyright (c) 1992, 1997 John E. Davis
...
static void write_attributes (unsigned short *src, unsigned int count)
{
   register unsigned char *p;
...
static void
write_attributes (unsigned short *src, unsigned int count)
{
   register unsigned short pair;
   unsigned int n;
