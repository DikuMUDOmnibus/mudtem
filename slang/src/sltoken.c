...
static unsigned char Char_Type_Table[256][2] =
{
 ...
 { BAD_CHAR, 0 },	/* ‚ */	    { BAD_CHAR, 0 },	/* ƒ */
 { BAD_CHAR, 0 },	/* „ */	    { BAD_CHAR, 0 },	/* … */
 { BAD_CHAR, 0 },	/* † */	    { BAD_CHAR, 0 },	/* ‡ */
 { BAD_CHAR, 0 },	/* ˆ */	    { BAD_CHAR, 0 },	/* ‰ */
 { BAD_CHAR, 0 },	/* Š */	    { BAD_CHAR, 0 },	/* ‹ */
 { BAD_CHAR, 0 },	/* Œ */	    { BAD_CHAR, 0 },	/*  */
 { BAD_CHAR, 0 },	/* Ž */	    { BAD_CHAR, 0 },	/*  */
 { BAD_CHAR, 0 },	/*  */	    { BAD_CHAR, 0 },	/* ‘ */
 { BAD_CHAR, 0 },	/* ’ */	    { BAD_CHAR, 0 },	/* “ */
 { BAD_CHAR, 0 },	/* ” */	    { BAD_CHAR, 0 },	/* • */
 { BAD_CHAR, 0 },	/* – */	    { BAD_CHAR, 0 },	/* — */
 ...
 { BAD_CHAR, 0 },	/* š */	    { BAD_CHAR, 0 },	/* › */
 { BAD_CHAR, 0 },	/* œ */	    { BAD_CHAR, 0 },	/*  */
 { BAD_CHAR, 0 },	/* ž */	    { BAD_CHAR, 0 },	/* Ÿ */
 { BAD_CHAR, 0 },	/*   */	    { BAD_CHAR, 0 },	/* ¡ */
 { BAD_CHAR, 0 },	/* ¢ */	    { BAD_CHAR, 0 },	/* £ */
 { BAD_CHAR, 0 },	/* ¤ */	    { BAD_CHAR, 0 },	/* ¥ */
 { BAD_CHAR, 0 },	/* ¦ */	    { BAD_CHAR, 0 },	/* § */
 { BAD_CHAR, 0 },	/* ¨ */	    { BAD_CHAR, 0 },	/* © */
 { BAD_CHAR, 0 },	/* ª */	    { BAD_CHAR, 0 },	/* « */
 { BAD_CHAR, 0 },	/* ¬ */	    { BAD_CHAR, 0 },	/* ­ */
 { BAD_CHAR, 0 },	/* ® */	    { BAD_CHAR, 0 },	/* ¯ */
 { BAD_CHAR, 0 },	/* ° */	    { BAD_CHAR, 0 },	/* ± */
 { BAD_CHAR, 0 },	/* ² */	    { BAD_CHAR, 0 },	/* ³ */
 { BAD_CHAR, 0 },	/* ´ */	    { BAD_CHAR, 0 },	/* µ */
 { BAD_CHAR, 0 },	/* ¶ */	    { BAD_CHAR, 0 },	/* · */
 { BAD_CHAR, 0 },	/* ¸ */	    { BAD_CHAR, 0 },	/* ¹ */
 { BAD_CHAR, 0 },	/* º */	    { BAD_CHAR, 0 },	/* » */
 { BAD_CHAR, 0 },	/* ¼ */	    { BAD_CHAR, 0 },	/* ½ */
 { BAD_CHAR, 0 },	/* ¾ */	    { BAD_CHAR, 0 },	/* ¿ */
 { BAD_CHAR, 0 },	/* À */	    { BAD_CHAR, 0 },	/* Á */
 { BAD_CHAR, 0 },	/* Â */	    { BAD_CHAR, 0 },	/* Ã */
 { BAD_CHAR, 0 },	/* Ä */	    { BAD_CHAR, 0 },	/* Å */
 { BAD_CHAR, 0 },	/* Æ */	    { BAD_CHAR, 0 },	/* Ç */
 { BAD_CHAR, 0 },	/* È */	    { BAD_CHAR, 0 },	/* É */
 { BAD_CHAR, 0 },	/* Ê */	    { BAD_CHAR, 0 },	/* Ë */
 { BAD_CHAR, 0 },	/* Ì */	    { BAD_CHAR, 0 },	/* Í */
 { BAD_CHAR, 0 },	/* Î */	    { BAD_CHAR, 0 },	/* Ï */
 { BAD_CHAR, 0 },	/* Ð */	    { BAD_CHAR, 0 },	/* Ñ */
 { BAD_CHAR, 0 },	/* Ò */	    { BAD_CHAR, 0 },	/* Ó */
 { BAD_CHAR, 0 },	/* Ô */	    { BAD_CHAR, 0 },	/* Õ */
 { BAD_CHAR, 0 },	/* Ö */	    { BAD_CHAR, 0 },	/* × */
 { BAD_CHAR, 0 },	/* Ø */	    { BAD_CHAR, 0 },	/* Ù */
 { BAD_CHAR, 0 },	/* Ú */	    { BAD_CHAR, 0 },	/* Û */
 { BAD_CHAR, 0 },	/* Ü */	    { BAD_CHAR, 0 },	/* Ý */
 { BAD_CHAR, 0 },	/* Þ */	    { BAD_CHAR, 0 },	/* ß */
 { BAD_CHAR, 0 },	/* à */	    { BAD_CHAR, 0 },	/* á */
 { BAD_CHAR, 0 },	/* â */	    { BAD_CHAR, 0 },	/* ã */
 { BAD_CHAR, 0 },	/* ä */	    { BAD_CHAR, 0 },	/* å */
 { BAD_CHAR, 0 },	/* æ */	    { BAD_CHAR, 0 },	/* ç */
...
static unsigned long hex_atoul (unsigned char *s)
{
   register unsigned char ch;
