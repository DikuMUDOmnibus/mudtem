...
\seealso{__get_reference, is_defined, typeof, eval}
\done
...
\description
   The \var{_slang_version} variable is read-only and its value
   contains the version number of the slang library.
\done
