...
DECLARE_OLC_FUN( raedit_noclase		);
DECLARE_OLC_FUN( raedit_odio		);
...
DECLARE_OLC_FUN( hedit_texto		);
DECLARE_OLC_FUN( hedit_new		);
DECLARE_OLC_FUN( hedit_nivel		);
...
void		free_exit		args ( ( ROOM_INDEX_DATA *, EXIT_DATA * ) );
