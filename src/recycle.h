...
void		free_learned	args( ( sh_int *temp ) );

/* Skill hash */
struct skhash *	new_skhash	args( ( void ) );
void		free_skhash	args( ( struct skhash * ) );

/* Mob Fight Data */
MF_DATA *	new_mfd		args( ( void ) );
void		free_mfd	args( ( MF_DATA * ) );

/* Banco */
void		extract_bank	args( ( PC_DATA *, BANK_DATA * ) );
...
/* Peticiones */
void		petition_delete	args( ( PETITION_DATA * ) );
